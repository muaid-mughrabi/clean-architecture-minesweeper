...
from minesweeper.model.boardgenerator import StandardBoardGenerator
...
class TestBoard(unittest.TestCase):
    def setUp(self):
        ...
        self.height = 10
        self.mines = 10
        self.generator = StandardBoardGenerator()
        self.board = Board(
            self.width, self.height, self.mines, generator=self.generator, revealer=None
        )
    ...
    def test_reveal_cell_within_bounds(self):
        x, y = 2, 2
        expected_value = self.board.board[y, x]
        ...
        self.assertTrue(self.board.mask[y, x], "The cell should be marked as revealed.")
